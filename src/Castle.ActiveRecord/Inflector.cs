...
namespace Castle.ActiveRecord
{
	...
	public static class Inflector
	{
		...
		private static void AddIrregular(this string singular, string plural)
		{
			AddPlural("(" + singular[0] + ")" + singular.Substring(1) + "$", "$1" + plural.Substring(1));
			AddSingular("(" + plural[0] + ")" + plural.Substring(1) + "$", "$1" + singular.Substring(1));
		}

		private static void AddUncountable(this string word)
		{
			Uncountables.Add(word.ToLower());
		}

		private static void AddPlural(this string rule, string replacement)
		{
			Plurals.Add(new Rule(rule, replacement));
		}

		private static void AddSingular(this string rule, string replacement)
		{
			Singulars.Add(new Rule(rule, replacement));
		}

		private static string ApplyRules(this IList<Rule> rules, string word)
		{
			string result = word;
