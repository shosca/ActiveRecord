...
namespace Castle.ActiveRecord
{
	...
	/// </summary>
	public abstract class ActiveRecordBaseQuery<T, TR> : IActiveRecordQuery<T, TR>, ICloneable
	{
		...
		{
			ActiveRecordBaseQuery<T, TR> clone = (ActiveRecordBaseQuery<T, TR>) MemberwiseClone();
		...
		/// </summary>
		public static IList GetModifiers(ActiveRecordBaseQuery<T, TR> query)
		{
